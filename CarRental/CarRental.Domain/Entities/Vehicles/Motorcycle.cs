...
namespace CarRental.Domain.Entities.Vehicles
{
    ...
    public class Motorcycle : Vehicle
    {
        ...
        public Motorcycle(string brandName, DateTime fabricationDate, string plate, string motorNumber, Color color, Color color2, Insurance insurance, Somaton somaton, string model, int passengerCapacity, Price price, int wheelAmount, int weight, bool hasSideCar) : base(brandName, fabricationDate, plate, motorNumber, color, color2, insurance, somaton, model, passengerCapacity, price, wheelAmount, weight)
        {
